...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_right">
            <h3><?php echo $data['page_title']; ?> <small>التعديل علي صلاحيات المجموعة </small></h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form action="<?php echo ADMINURL . '/groups/edit/' . $data['group_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" >
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="radio">
                        ...
                        ?>
                        <label class="">
                            <input type="radio" class="flat" value="1" <?php echo isset($data['permissions']->admin_login->view) ? 'checked' : ''; ?> name="permissions[admin_login][view]" > السماح 
                        </label>
                        <label class="">
                            <input type="radio" class="flat" value="0" <?php echo empty($data['permissions']->admin_login->view) ? 'checked' : ''; ?> name="permissions[admin_login][view]"> عدم السماح
                        </label>
                    </div>
                </div>
                <div class="row">
