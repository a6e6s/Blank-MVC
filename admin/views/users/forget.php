            ...
            <?php flash('user_msg'); ?>
                <div class="col-lg-12 profile_details">
                    <div class="well profile_view">
                        <form class="login_content" action="<?php echo ADMINURL . '/users/forget/'; ?>" method="post">
                            <div class="col-sm-12">
                                <h4 class="brief"> نسيت كلمة المرور</h4><br />
                                <div><i class="fa fa-lock fa-5x"></i></div>
                                <br />
                                <p>من فضلك قم بكتابة بريدك المسجل لدينا لاستعادة كلمة المرور</p>
                            ...
                            <div class="col-xs-12 bottom">
                                <input class="btn btn-primary" value="ارسال" name="login" type="submit" />
                                <a class="reset_pass" href="<?php echo ADMINURL . '/users/login/'; ?>">العودة الي تسجيل الدخول ؟</a>
                            </div>
                        </form>
                    </div>
                </div>
