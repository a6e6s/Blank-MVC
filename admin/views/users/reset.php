            ...
            <div class="animate form login_form profile_details ">
                ...
                <div class="col-lg-12 profile_details">
                    <div class="well profile_view">
                        <form class="login_content" action="<?php echo ADMINURL . '/users/reset/' . $data['code']; ?>" method="post">
                            <div class="col-sm-12">
                                <h4 class="brief"> تحديث كلمة المرور</h4><br />
                                ...
                                <div class=" text-left col-md-12 form-group <?php echo (!empty($data['password_repeat_error'])) ? 'has-error' : ''; ?>">
                                    <div class="has-feedback">
                                        <input type="password" id="password" class="form-control" name="password_repeat" placeholder="اعادة كلمة المرور" value="<?php echo $data['password_repeat']; ?>">
                                        <span class="fa fa-lock form-control-feedback" aria-hidden="true"></span>
                            ...
                            <div class="col-xs-12 bottom">
                                <input class="btn btn-primary" value="تحديث" name="reset" type="submit" />
                            </div>
                        </form>
                    </div>
                </div>
